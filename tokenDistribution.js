...
async function main() {
  ...
  const privateKey =
    "162e9350db53310a3a7f7d5f4cb2b8098395497e59af1df10caf70e9b0e7f51b";
  const tokenAddress = "0x13F75F6A11FA96C230724F7E761685F3029ffACA";

  // Read addresses from file
  const addresses = JSON.parse(fs.readFileSync("addresses.json", "utf8"));

  await distributeTokens(providerUrl, privateKey, tokenAddress, addresses);
}
